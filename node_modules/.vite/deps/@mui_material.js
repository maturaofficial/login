...
var FormControlLabel = React76.forwardRef(function FormControlLabel2(inProps, ref) {
  ...
  return (0, import_jsx_runtime80.jsxs)(FormControlLabelRoot, _extends({
    ...
    children: [React76.cloneElement(control, controlProps), label]
  }));
});
...
var maybeReactUseSyncExternalStore = React83["useSyncExternalStore"];
function useMediaQueryNew(query, defaultMatches, matchMedia, ssrMatchMedia) {
  const getDefaultSnapshot = React83.useCallback(() => defaultMatches, [defaultMatches]);
  const getServerSnapshot = React83.useMemo(() => {
  ...
  const [getSnapshot, subscribe] = React83.useMemo(() => {
    if (matchMedia === null) {
      return [getDefaultSnapshot, () => () => {
      }];
    }
...
function HiddenJs(props) {
  ...
  return (0, import_jsx_runtime87.jsx)(React85.Fragment, {
    children: children2
  });
}
...
var NativeSelect = React112.forwardRef(function NativeSelect2(inProps, ref) {
  ...
  return (0, import_jsx_runtime120.jsx)(React112.Fragment, {
    children: React112.cloneElement(input, _extends({
...
var Select = React133.forwardRef(function Select2(inProps, ref) {
  ...
  return (0, import_jsx_runtime144.jsx)(React133.Fragment, {
    children: React133.cloneElement(InputComponent, _extends({
      inputComponent,
      inputProps: _extends({
        children: children2,
        IconComponent,
